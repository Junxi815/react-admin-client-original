...
export default class ProductDetail extends Component {
    ...
    async componentDidMount(){
        const {pCategoryId, categoryId} = storageUtils.getProduct()
        if(pCategoryId === '0'){
    ...
    componentWillUnmount(){
        //refresh makes memory dispear
        // memoryUtils.product = {}
        storageUtils.removeProduct()
    }

    render() {
        const {name,desc,price,imgs,detail} = storageUtils.getProduct()
